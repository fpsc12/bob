...
function autoadvance() {
    var increment = 0;
    if ([].includes(x = $("#activity-title").text()) && ($("#activity-status").text() != "Complete")) {
...
function GuessPractice() {
    ...
    if (["Instruction", "Warm-Up", "Summary", "Lecture", "Assignment", "Practice", "Virtual Lab", "Assignment: Reflect on the Lab", "Part 1", "Part 2", "Part 3", "Unit Wrap-Up", "Career Connection"].includes(document.getElementById("activity-title").innerText)) {
         var numOption
